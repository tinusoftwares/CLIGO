...
class BookingDetailsCardWidget extends StatelessWidget {
  ...
  String policyString = "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.";
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          bookingHistoryInfo.special==''?Container():
          customTextFormatWithValueRowLine('Special', bookingHistoryInfo.special.toString()),

          bookingHistoryInfo.adult==''?Container():
          customTextFormatWithValueRowLine('Adult', bookingHistoryInfo.adult.toString()),

          bookingHistoryInfo.chield==''?Container():
          customTextFormatWithValueRowLine('Child', bookingHistoryInfo.chield.toString()),
          customTextFormatWithValueRowLine('total seat', bookingHistoryInfo.totalseat.toString()),
            ...
            children: [
              ...
              Expanded(
                ...
                Container(
                    ...
                    margin: EdgeInsets.symmetric(vertical: 2,horizontal: 2),
                    padding: EdgeInsets.symmetric(vertical: 5,horizontal: 2),
                    child: customTextFormatWithValueRowLine('Booking Date', bookingHistoryInfo.journeydata.toString().substring(0,10))),),
            ],
          ),
          Divider(
            color: Colors.grey,
